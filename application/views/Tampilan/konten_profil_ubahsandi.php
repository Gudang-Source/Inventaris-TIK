		...
		<div class="col-md-3">
				...
				<div class="box box-primary">
						<div class="box-body box-profile">
								<img class="profile-user-img img-responsive img-circle" src="http://localhost/Inventaris-TIK/assets/foto_profil/avatar.svg" alt="User profile picture">
		...
		<div class="col-md-9">
				<div class="nav-tabs-custom">
						<ul class="nav nav-tabs">
								<li><a href="#DataAdmin" data-toggle="tab">Data Admin</a></li>
